  ...
  (b = (function () {
    function c(c, d) {
      ...
      (e.defaults = {
        ...
        asNavFor: null,
        prevArrow:
          '<button type="button" data-role="none" class="slick-prev-col-prod" aria-label="Previous" tabindex="0" role="button">Previous</button>',
        nextArrow:
          '<button type="button" data-role="none" class="slick-next-col-prod" aria-label="Next" tabindex="0" role="button">Next</button>',
        autoplay: !1,
        autoplaySpeed: 3e3,
        centerMode: !1,
        centerPadding: "50px",
