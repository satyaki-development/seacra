  ...
  (b = (function () {
    ...
    (b.prototype.checkResponsive = function (b, c) {
      ...
      if (
        ...
        console.log("OPtions): ",  d.options.responsive),
        ...
        null !== f
          ? null !== d.activeBreakpoint
            ? (f !== d.activeBreakpoint || c) &&
              ...
              (h = f))
            : ((d.activeBreakpoint = f),
               console.log("BreakPoints_2 : ", d.breakpoints, d.activeBreakpoint),
              "unslick" === d.breakpointSettings[f]
                ? d.unslick(f)
                : ((d.options = a.extend(
                    {},
      ...
      console.log("BreakPoints: ", d.breakpoints, d.activeBreakpoint);
    }),
