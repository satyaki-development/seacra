(() => {
  ...
  (i.n = t => {
    ...
    const e = "rendered",
      s = (t, e) => {
        ...
        return "mousedown" === e.type
          ...
          : ((s = e.touches[0].clientX), (o = e.touches[0].clientY)), s >=
          i.x &&
          s <= i.x + i.width &&
          o >= i.y &&
          o <= i.y + i.height;
    ...
    o.innerHTML =
      '<div class="second" id="second"> <slot name="second"><slot name="before"></slot></slot> </div> <div class="first" id="first"> <div class="first-overlay"> <div class="first-overlay-container" id="firstImageContainer"> <slot name="first"><slot name="after"></slot></slot> </div> </div> <div class="handle-container"> <div class="divider"></div> <div class="handle" id="handle"> <slot name="handle"> <svg width="22" height="23" viewBox="0 0 22 23" fill="none" xmlns="http://www.w3.org/2000/svg"> <ellipse cx="11.2424" cy="11.6448" rx="10.758" ry="11.3557" fill="white"/> <path d="M15.9794 4.1943C15.9875 4.33585 15.8991 4.46472 15.7575 4.47224C15.4166 4.49036 15.084 4.50457 14.756 4.5452C13.8176 4.65906 12.9185 4.88912 12.1619 5.45846C11.3291 6.08589 10.9532 6.94105 11.1498 7.90543C11.3488 8.87911 11.7074 9.8249 12.0341 10.7707C12.3805 11.7792 12.7883 12.7669 12.9627 13.8219C13.3337 16.0667 12.5181 17.8537 10.6535 19.234C9.90776 19.7875 9.06662 20.1729 8.15623 20.4798C7.93656 20.5539 7.64793 20.4301 7.65653 20.1984V20.1984C7.65898 20.1264 7.76462 20.0288 7.84814 19.9939C8.66618 19.657 9.46457 19.2828 10.1426 18.7251C11.5674 17.5516 12.2577 16.0853 12.098 14.2797C11.9924 13.0736 11.5551 11.9558 11.1571 10.8265C10.882 10.048 10.5798 9.26951 10.4079 8.47012C9.92149 6.23229 11.0712 4.58005 13.4221 4.10832C14.1198 3.96889 14.8469 3.96192 15.5618 3.88059C15.832 3.85038 15.9622 3.941 15.9794 4.1943V4.1943Z" fill="#CC4E61"/> </svg> </slot> </div> </div> </div> ';
    const n = { ArrowLeft: -1, ArrowRight: 1 },
      r = ["horizontal", "vertical"],
      a = t => ({ x: t.touches[0].pageX, y: t.touches[0].pageY }),
      l = t => ({ x: t.pageX, y: t.pageY });
    class d extends HTMLElement {
      constructor() {
        super(), (this.exposure = this.hasAttribute("value")
          ? parseFloat(this.getAttribute("value"))
          : 50), (this.slideOnHover = !1), (this.slideDirection =
          "horizontal"), (this.keyboard =
          "enabled"), (this.isMouseDown = !1), (this.animationDirection = 0), (this.isFocused = !1), (this.handle = !1), (this.onMouseMove = t => {
          ...
          const e = l(t);
          this.slideToPage(e), this.focus(), (this.bodyUserSelectStyle =
            window.document.body.style.userSelect), (window.document.body.style.userSelect =
            "none");
        }), (this.onWindowMouseUp = () => {
          (this.isMouseDown = !1), (window.document.body.style.userSelect = this.bodyUserSelectStyle), window.removeEventListener(
            "mousemove",
            this.onMouseMove
          ...
          if (!this.hasTouchMoved) {
            ...
            if (
              ...
              return (this.isTouchComparing = !0), this.focus(), this.slideToPage(
                e
              ), t.preventDefault(), !1;
          ...
          this.stopSlideAnimation(), (this.isFocused = !1), this.firstElement.classList.remove(
            "focused"
          );
        }), (this.onFocus = () => {
        ...
        (i.innerHTML = t.Z), this.getAttribute("nonce") &&
          i.setAttribute("nonce", this.getAttribute("nonce")), e.appendChild(
          i
        ), e.appendChild(
          o.content.cloneNode(!0)
        ), (this.firstElement = e.getElementById(
          "first"
        )), (this.secondElement = e.getElementById(
          "second"
      ...
      set value(t) {
        ...
        e !== this.exposure &&
          ((this.exposure = e), this.enableTransition(), this.setExposure());
      }
      get hover() {
      ...
      set hover(t) {
        (this.slideOnHover =
          "false" !== t.toString().toLowerCase()), this.removeEventListener(
          "mousemove",
          this.onMouseMove
        ), this.slideOnHover &&
      ...
      set direction(t) {
        (this.slideDirection = t.toString().toLowerCase()), this.slide(
          0
        ), this.firstElement.classList.remove(...r), r.includes(
          this.slideDirection
      ...
      connectedCallback() {
        this.hasAttribute("tabindex") ||
          (this.tabIndex = 0), this.addEventListener(
          "dragstart",
          t => (t.preventDefault(), !1)
        ), new ResizeObserver(this.resetDimensions).observe(
          this
        ), this.setExposure(0), (this.keyboard =
          ...
          "keydown",
          this.onKeyDown
        ), this.addEventListener("keyup", this.onKeyUp), this.addEventListener(
          "focus",
          this.onFocus
          ...
          "mousedown",
          this.onMouseDown
        ), (this.handle = this.hasAttribute("handle")), (this.hover =
          !!this.hasAttribute("hover") &&
          this.getAttribute("hover")), (this.direction = this.hasAttribute(
          "direction"
        )
          ? this.getAttribute("direction")
          : "horizontal"), this.resetDimensions(), this.classList.contains(e) ||
          this.classList.add(e), this.querySelectorAll(
      ...
      attributeChangedCallback(t, e, i) {
        "hover" === t && (this.hover = i), "direction" === t &&
          (this.direction = i), "keyboard" === t &&
      ...
      setExposure(t = 0) {
        ...
        (this.exposure = (
          100,
          (e = this.exposure + t) < 0 ? 0 : e > 100 ? 100 : e
      ...
      slideToPage(t) {
        "horizontal" === this.slideDirection &&
          this.slideToPageX(t.x), "vertical" === this.slideDirection &&
          this.slideToPageY(t.y);
      }
      slideToPageX(t) {
      ...
      stopSlideAnimation() {
        (this.animationDirection = 0), this.firstElement.style.setProperty(
          "--transition-time",
          "var(--default-transition-time)"
        );
      }
